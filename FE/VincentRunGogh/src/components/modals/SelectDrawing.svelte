...
<div class="flex justify-around">
  <GradientButton color="greenToBlue" size="sm" on:click={freeDrawing} pill>
    <svg
      ...
      /></svg
    >자유 드로잉</GradientButton
  >
  <GradientButton color="redToYellow" size="sm" on:click={routeList} pill>
    <PaletteOutline class="me-2" size="sm" /> 루트 드로잉
  </GradientButton>
</div>
