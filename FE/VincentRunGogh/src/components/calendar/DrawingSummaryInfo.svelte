<script lang="ts">
  import { formatSecToHMS, formatSecToH, formatDistanceFix2 } from '@/utils/formatter';

  export let time: number;
  export let averagePace: number | null;
...
<div class="summary-info">
  ...
  <div class="info">
    ...
    <div class="value">{formatDistanceFix2(distance)} km</div>
  </div>
</div>
